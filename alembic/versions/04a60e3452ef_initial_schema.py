...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'EXTRACTED', 'EMBEDDED', 'FAILED', name='documentstatus', native_enum=False, length=20), nullable=False),
    ...
    op.create_index(op.f('ix_documents_course_tag'), 'documents', ['course_tag'], unique=False)
