...
# Skriver över alembic.ini's platshållar-URL med den riktiga, byggd från
# .env via Settings - samma SSOT-princip som config.py's docstring
config.set_main_option("sqlalchemy.url", settings.database_url)  # NYTT
